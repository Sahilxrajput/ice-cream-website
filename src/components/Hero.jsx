  ...
  return (
    <div className="h-screen w-screen flex justify-center bg-cover overflow-hidden pt-8 bg-primary">
      ...
      <section className="flex-1/2 flex flex-col justify-center items-center gap-8 relative">
        <h1 className="font-berkshire text-center text-chocolate text-8xl font-thin tracking-wider text-shadow ">
        ...
        <p className="max-w-xl">
          Life&apos;s too short for boring desserts. Dive into rich, creamy, and
          unforgettable flavors made to melt your stress away.
        </p>
